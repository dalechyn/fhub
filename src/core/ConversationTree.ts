 ...
 * structure.
 */
export type ConversationTree<cast extends Cast.Cast = Cast.Cast> = {
...
export function linearize<cast extends Cast.Cast = Cast.Cast>({
  tree,
...
export declare namespace linearize {
  type ParametersType<cast extends Cast.Cast = Cast.Cast> = {
    tree: ConversationTree<cast>
  }
  type ReturnType = Cast.Cast[][]
}

export function log<cast extends Cast.Cast = Cast.Cast>({
  tree,
