...
Creates a recast [`Reaction.Reaction`](/api/Reaction/types#reaction) and sends it to Hub.
...
- **Type:** `recastPreconstruct.ReturnType`
...
Submitted Recast creation message
