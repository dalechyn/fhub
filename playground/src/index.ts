import { Account, Client, Pagination, ReactionAdd, Transport } from 'fhub'
import { Casts, Watch } from 'fhub/actions'

const client = Client.create(
  Transport.grpcNode({ baseUrl: 'https://hub-grpc.pinata.cloud' }),
)
const cast = await Casts.getRoot(client, {
  fid: 11517n,
  hash: '0x93534c81d5bb02b3f753be6478bc1d69ccb71d24',
})

for await (const _message of Watch.watchCasts(client)) {
}

const _formatted = await Casts.likePreconstruct({ cast, a })
//
